...
现象：在开源项目（如 UnoCSS v0.65.3、Slidev v0.50.0）中使用v0.x.x版本号，类似项目还有 React Native v0.76.5、sharp v0.33.5。

误解：人们常认为零主版本号表示软件未准备好生产环境，但上述项目实际稳定且被数百万项目使用。
...
- 人类对数字的感知是按对数字的尺度进行的。
  - 我们倾向于将 v2.0 到 v3.0 视为一个巨大的、开创性的更改
  - 而 v125.0 到 v126.0 则显得很难传达重大更改的重要性
